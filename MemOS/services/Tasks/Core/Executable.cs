...
namespace MemOS.Emulation
{
    public class Executable
    {
        ...
        public void NextInstruction()
        {
            ...
            {
                Console.WriteLine($"Error while executing program instructions:\n{ex.Message}");
                ...
                try
                {
                    ...
                    {
                        file = $@"0:\System\logs\dump_{DateTime.Now.Day}{DateTime.Now.Month}_{DateTime.Now.Hour}{DateTime.Now.Minute}_{DateTime.Now.Second}.dat";
        ...
        public void ReadData()
        {
            ...
            {
                Console.WriteLine($"Error reading executable data: {ex.Message}");
            }
        }
    }
}
